...
const dummyParameters = [
  { parameter: "Hemoglobin", value: "13.5", unit: "g/dL", referenceRange: "13.0-17.0" },
  { parameter: "Cholesterol", value: "180", unit: "mg/dL", referenceRange: "<200" },
  { parameter: "Blood Sugar", value: "95", unit: "mg/dL", referenceRange: "70-99" },
];
...
app.post("/upload", upload.single("report"), async (req, res) => {
  ...
  try {
    ...
    console.log("Extracted text (truncated):", extractedText.substring(0, 500));
